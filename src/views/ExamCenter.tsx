...
import { useRouter, useSearchParams } from "next/navigation"; // সঠিক ইমপোর্ট
...
const ExamCenter: React.FC = () => {
  ...
  const searchParams = useSearchParams(); // এখানে [] হবে না
  ...
  // সাবজেক্ট না পাওয়া গেলে ডাইনামিক এরর স্ক্রিন
  if (chaptersForSubject.length === 0 && groupParam && subjectParam) {
    const errorTitle = lang === "bn" ? `${subjectName} পাওয়া যায়নি` : `${subjectName} Not Found`;
      ...
      <div className="min-h-screen bg-[#FDFCF8] dark:bg-gray-950 flex flex-col items-center justify-center p-6">
        ...
        >
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm font-medium mb-8 leading-relaxed">
            {lang === "bn"
              ? `দুঃখিত! ${subjectName} বিষয়ের জন্য এখনো কোনো প্রশ্ন বা অধ্যায় আমাদের ডাটাবেজে যুক্ত করা হয়নি।`
              : `Apologies! No questions or chapters have been uploaded for ${subjectName} yet.`}
          </p>

          <button
            onClick={() => navigate.back()} // এখানে ফাংশন কল () করতে হবে
